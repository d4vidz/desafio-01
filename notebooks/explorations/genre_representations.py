...
def _():
    ...
    return CONTINUOUS_AUDIO_FEATURES, Path, build_data_layer, fit_genre_ppmi, genre_audio_profiles, genre_membership_matrix, go, mo, np, pl, robust_pca_profiles, root
